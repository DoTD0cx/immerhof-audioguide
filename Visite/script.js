/* =====================================================================
   ...
   La mise en cache hors ligne démarre toute seule au premier audio lancé.
   ===================================================================== */
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Premier audio réellement lancé : on enregistre toute la visite en tâche de fond.
  audio.addEventListener("playing", () => {
    if (miseEnCacheLancee) return;
    miseEnCacheLancee = true;
    setTimeout(() => { toutEnregistrer(stations[indexCourant]); }, 1200);
  }, { once: false });
