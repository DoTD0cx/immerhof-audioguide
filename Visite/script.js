document.addEventListener("DOMContentLoaded", async () => {
  ...
  const stations = [
    ...
    { numero: "08", titre: "Cuisine", audio: "./Audio/08-cuisine.mp3" },
    { numero: "09", titre: "Infirmerie", audio: "./Audio/06-infirmerie.mp3" },
    { numero: "10", titre: "Casernement", audio: "./Audio/10-casernement.mp3" },
    { numero: "11", titre: "Bloc 1 et Bloc 2", audio: "./Audio/11-Infanterie.mp3" },
    { numero: "12", titre: "Bloc 3", audio: "./Audio/12-Bloc-3.mp3" }
  ];
